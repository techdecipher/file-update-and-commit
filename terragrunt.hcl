  ...
  cmk_user_iam_arns = [
    {
      name       =       [
        ...
        "arn:aws:iam::123456789012:role/tesla"
      ]
      conditions = []
    }
  ]
...
source_policy_documents = [
  ...
  "arn:aws:iam::123456789012:role/tesla"
      ...
      },       ,{         Sid       = "ProjectAccess"         Effect    = "Allow"         Principal = { AWS = "arn:aws:iam::123456789012:role/tesla" }         Action    = ["s3:ListBucket"]         Resource  = "arn:aws:s3:::neptune"       }
    ]
  })
]
